    ...
    <div>
      ...
      <div className="bg-gray-100 dark:bg-gray-800 p-6 md:p-8 lg:p-10 w-64 hidden md:block">
        <nav className="space-y-2">
          <Link
            className="flex items-center gap-2 px-3 py-2 rounded-md hiver:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
            href={`/repos/${params.orgName}/${params.repoName}`}
          >
...
function BarChart(props: React.JSX.IntrinsicAttributes & React.ClassAttributes<HTMLDivElement> & React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div {...props}>
      <ResponsiveBar
        data={[
...
function GitCommitVerticalIcon(props: React.JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
...
function GitForkIcon(props: React.JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
...
function GitPullRequestIcon(props: React.JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
...
function RefreshCcwIcon(props: React.JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
